...
## 2026-09-09 — T5.20 · A scene-level interaction test, and the defect it found
...
the base to `4.4.0` — renumbered to `5.1.0` when it landed, the split having merged first. Recorded gotcha 73.
