...
| surprised by the engine | the gotcha list in `docs/CONTEXT.md` — thirty-two, each cost an hour |
...
| know where things stand | [`docs/CONTEXT.md`](docs/CONTEXT.md) — state, settled decisions, thirty-two gotchas |
| understand why this is a template and not a game | [`docs/TEMPLATE.md`](docs/TEMPLATE.md) |
| **add an area, an NPC, a conversation, an item, an object, a quest** | **[`docs/AUTHORING.md`](docs/AUTHORING.md)** |
