...
| surprised by the engine | the gotcha list in `docs/CONTEXT.md` — sixty-three, each cost an hour |
...
"$G" --headless res://tests/test_runner.tscn --quit-after 400   # 1,798 assertions, exit 1 on fail
...
| know where things stand | [`docs/CONTEXT.md`](docs/CONTEXT.md) — state, settled decisions, sixty-three gotchas |
