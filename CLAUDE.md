...
| surprised by the engine | the gotcha list in `docs/CONTEXT.md` — seventy-nine, each cost an hour |
...
"$G" --headless res://tests/test_runner.tscn --quit-after 400   # 2,362 assertions, exit 1 on fail
...
| know where things stand | [`docs/CONTEXT.md`](docs/CONTEXT.md) — state, settled decisions, seventy-nine gotchas |
