...
| surprised by the engine | the gotcha list in `docs/CONTEXT.md` — fifty-six, each cost an hour |
...
"$G" --headless res://tests/test_runner.tscn --quit-after 400   # 1,782 assertions, exit 1 on fail
...
| know where things stand | [`docs/CONTEXT.md`](docs/CONTEXT.md) — state, settled decisions, fifty-six gotchas |
