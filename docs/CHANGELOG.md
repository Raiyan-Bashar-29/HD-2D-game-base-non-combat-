...
**Numbered 5.1.0 rather than the 4.4.0 it was authored against.** The work was written on a
branch off 4.3.0 and landed after 5.0.0, so a 4.4.0 heading would have claimed it shipped
*before* the `dev_stage` split it actually follows. Nothing about the change itself differs.
